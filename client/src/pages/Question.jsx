        ...
        comments: [
          {
            ...
            memberId: 1,
            commenter: 'kim',
            date: '2023-04-20T17:07:51.69199',
          },
        ],
      },
      {
    ...
    comments: [
      {
        ...
        memberId: 1,
        commenter: 'kim',
        date: '2023-04-20T17:07:47.551306',
      },
      {
        commentId: 2,
        body: '질문의 댓글이당2',
          ...
          data.answers.map(answer => (
            <div className={styles.content} key={answer.answerId}>
              ...
              <div className={styles.paragraph}>
                ...
                <Acomment answer={answer} date={calDate(answer.date)} />
                <AddComment />
              </div>
            </div>
          ))}
